...
```
git clone git@github.com:Tedyst/MultiMC5-Cracked.git
git submodule init
...
git clone --recursive https://github.com/Tedyst/MultiMC5-Cracked.git src
...
2. Once that is open, change into your user directory, and clone MultiMC by doing `git clone --recursive https://github.com/Tedyst/MultiMC5-Cracked.git`, and change directory to the folder you cloned to.
...
```
git clone https://github.com/Tedyst/MultiMC5-with-offline.git
cd MultiMC5
git submodule init
git submodule update
mkdir build
